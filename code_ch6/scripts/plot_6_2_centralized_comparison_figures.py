#!/usr/bin/env python3
"""Plot Section 6.2 centralized comparison QL_ratio figures.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--comparison-results",
        default=str(ROOT / "results" / "6_2_centralized_comparison"),
        help="Directory or metrics_raw.csv containing Chapter 6.2 comparison rows.",
    )
